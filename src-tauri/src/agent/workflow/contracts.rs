...
impl Role {
    ...
    pub(super) fn writes(self) -> bool { matches!(self, Self::Builder | Self::Designer | Self::Writer) }
    pub(super) fn label(self) -> &'static str { match self {
        Self::Planner => "Planejador", Self::Investigator => "Investigador", Self::Writer => "Redator", Self::Orchestrator => "Orquestrador", Self::Designer => "Designer", Self::Builder => "Construtor", Self::Reviewer => "Revisor",
    } }
    ...
    pub(super) fn contract(self) -> &'static str { match self {
