...
export function bead(overrides: Partial<Bead> = {}): Bead {
  return { id: "j0123456789abcdef0123456789abcdef-a", title: "Validar integração", description: "Descrição **real** da tarefa", design: "", acceptance_criteria: "Todos os testes passam", notes: "Contexto persistido", status: "open", priority: 1, issue_type: "task", assignee: "", created_by: "Jarvis", created_at: "2026-09-05T10:00:00Z", updated_at: "2026-09-05T12:00:00Z", closed_at: null, close_reason: "", labels: [], dependencies: [], dependents: [], comment_count: 0, parent: null, metadata: { jarvis_conversation: "c1" }, ...overrides };
}
