...
describe("Persistent live conversation", () => {
  ...
  it("sends selected options, streams revisioned results and cancels only the current turn", async () => {
    ...
    expect(call).toHaveBeenCalledWith("start_agent_turn", { conversationId: "c1", content: "Leia o README", options: { executor: "jarvis", account: "openai-codex-pessoal", model: "model", reasoning: "medium", mode: "build", workflow: "standard", approvalMode: "yolo" } });
